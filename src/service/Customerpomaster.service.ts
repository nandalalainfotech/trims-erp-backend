...
export class CustomerpomasterService {
    ...
    async downloadExcel(unitslno: any, @Req() request: Request, @Res() response: Response) {
        ...
        for (let i = 0; i < customerPomaster.length; i++) {
            ...
            worksheet.getCell('J5:M5').value = {
                richText: [
                  { text: "PO Date:" + "\n\n" },
                  { font: { size: 11 }, text: "\n\n" + customerPomaster[i].poDate },
                ],
            };
            worksheet.getCell('J5:M5').font = { size: 11,bold: true};
            worksheet.getCell("J5:M5").alignment = {  vertical: "top", horizontal: "left",};
            ...
            worksheet.getCell('J6:M6').value =   {
                richText: [
                  { text: "Inspection Condition:" + "\n\n" },
                  { font: { size: 11 }, text: "\n\n" + customerPomaster[i].inspection },
                ],
              };
            worksheet.getCell('J6:M6').font = {
                size: 11,
                bold: true
            };
            worksheet.getCell("J6:M6").alignment = {  vertical: "top", horizontal: "left",};

           

            worksheet.mergeCells("A7");
            worksheet.getCell("A7").value = "Part Code";
            ...
            worksheet.getCell("B7").value = "Part Name";
            ...
            worksheet.getCell("D7").value = "UOM";
            ...
            worksheet.getCell("E7").value = "HSN/SAC";
            ...
            worksheet.getCell("F7").value = "Unit Rate";
            ...
            worksheet.getCell("G7").value = "Quantity";
            ...
            worksheet.getCell("H7").value = "TotalAmount";
            ...
            worksheet.getCell("I7").value = "Drawing No";
            ...
            worksheet.getCell("J7").value = "Revision No";
            ...
            worksheet.getCell("K7").value = "Revision Date";
            ...
            worksheet.getCell("L7").value = "HSN/SAC";
            ...
            worksheet.getCell("M7").value = "GST %";
            ...
            worksheet.getCell("A" + temp).value = customerPomaster[i].customerpoitem001wbs[j].prtcode ? part.find(x => x.slNo ===  customerPomaster[i].customerpoitem001wbs[j].prtcode)?.partno : "",
            ...
            worksheet.getCell("B" + temp).value = customerPomaster[i].customerpoitem001wbs[j].prtmname;
            ...
            worksheet.getCell("C" + temp).value = customerPomaster[i].customerpoitem001wbs[j].prtdescrip;
            ...
            worksheet.getCell("D" + temp).value = customerPomaster[i].customerpoitem001wbs[j].prtuom;
            ...
            worksheet.getCell("E" + temp).value = customerPomaster[i].customerpoitem001wbs[j].prthsn;
            ...
            worksheet.getCell("F" + temp).value = customerPomaster[i].customerpoitem001wbs[j].prtunitrate;
            ...
            worksheet.getCell("G" + temp).value = customerPomaster[i].customerpoitem001wbs[j].prtqunty;
            ...
            worksheet.getCell("H" + temp).value = customerPomaster[i].customerpoitem001wbs[j].prttotalamount;
            ...
            worksheet.getCell("I" + temp).value = customerPomaster[i].customerpoitem001wbs[j].drawingNo;
            ...
            worksheet.getCell("J" + temp).value = customerPomaster[i].customerpoitem001wbs[j].revisionNo;
            ...
            worksheet.getCell("K" + temp).value = customerPomaster[i].customerpoitem001wbs[j].revisionDate;
            ...
            worksheet.getCell("L" + temp).value = customerPomaster[i].customerpoitem001wbs[j].hsn;
            ...
            worksheet.getCell("M" + temp).value = customerPomaster[i].customerpoitem001wbs[j].gst;
    ...
    async downloadIDExcel(unitslno: any,id: any, @Req() request: Request, @Res() response: Response) {
      ...
      for (let i = 0; i < customerPomaster.length; i++) {
        ...
        let workbook = new excel.Workbook();
          ...
          worksheet.mergeCells("A" + temp);
          worksheet.getCell("A" + temp).value = cusPoitem[j].prtcode ? part.find(x => x.slNo ===  cusPoitem[j].prtcode)?.partno : "",
          worksheet.getCell("A" + temp).font = {
              size: 12,
              bold: true,
          };
          ...
          worksheet.mergeCells("B" + temp);
          worksheet.getCell("B" + temp).value = cusPoitem[j].prtmname;
          worksheet.getCell("B" + temp).font = {
              size: 12,
              bold: true,
          };
          ...
          worksheet.mergeCells("C" + temp);
          worksheet.getCell("C" + temp).value = cusPoitem[j].prtdescrip;
          worksheet.getCell("C" + temp).font = {
              size: 12,
              bold: true,
          };
          ...
          worksheet.mergeCells("D" + temp);
          worksheet.getCell("D" + temp).value = cusPoitem[j].prtuom;
          worksheet.getCell("D" + temp).font = {
              size: 12,
              bold: true,
          };
          ...
          worksheet.mergeCells("E" + temp);
          worksheet.getCell("E" + temp).value = cusPoitem[j].prthsn;
          worksheet.getCell("E" + temp).font = {
              size: 12,
              bold: true,
          };
          ...
          worksheet.mergeCells("F" + temp);
          worksheet.getCell("F" + temp).value = cusPoitem[j].prtunitrate;
          worksheet.getCell("F" + temp).font = {
              size: 12,
              bold: true,
          };
          ...
          worksheet.mergeCells("G" + temp);
          worksheet.getCell("G" + temp).value = cusPoitem[j].prtqunty;
          worksheet.getCell("G" + temp).font = {
              size: 12,
              bold: true,
          };
          ...
          worksheet.mergeCells("H" + temp);
          worksheet.getCell("H" + temp).value = cusPoitem[j].prttotalamount;
          worksheet.getCell("H" + temp).font = {
              size: 12,
              bold: true,
          };
          ...
          worksheet.mergeCells("I" + temp);
          worksheet.getCell("I" + temp).value = cusPoitem[j].drawingNo;
          worksheet.getCell("I" + temp).font = {
              size: 12,
              bold: true,
          };
          ...
          worksheet.mergeCells("J" + temp);
          worksheet.getCell("J" + temp).value = cusPoitem[j].revisionNo;
          worksheet.getCell("J" + temp).font = {
              size: 12,
              bold: true,
          };
          ...
          worksheet.mergeCells("K" + temp);
          worksheet.getCell("K" + temp).value = cusPoitem[j].revisionDate;
          worksheet.getCell("K" + temp).font = {
              size: 12,
              bold: true,
          };
          ...
          worksheet.mergeCells("L" + temp);
          worksheet.getCell("L" + temp).value = cusPoitem[j].hsn;
          worksheet.getCell("L" + temp).font = {
              size: 12,
              bold: true,
          };
          ...
          worksheet.mergeCells("M" + temp);
          worksheet.getCell("M" + temp).value = cusPoitem[j].gst;
          worksheet.getCell("M" + temp).font = {
              size: 12,
              bold: true,
          };
