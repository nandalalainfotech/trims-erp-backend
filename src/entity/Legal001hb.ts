...
@Index("cslno", ["cslno"], {})
@Index("fslno", ["fslno"], {})
@Entity("legal001hb", { schema: "trims" })
export class Legal001hb {
  [x: string]: any;
  ...
  @ManyToOne(() => Legal001mb, (legal001mb) => legal001mb.legal001hbs, {
    onDelete: "CASCADE",
    onUpdate: "RESTRICT",
  })
  ...
  @ManyToOne(() => File001mb, (file001mb) => file001mb.legal001hbs, {
    onDelete: "CASCADE",
    onUpdate: "RESTRICT",
  })
